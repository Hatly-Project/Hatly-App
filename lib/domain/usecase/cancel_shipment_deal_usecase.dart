...
class CancelShipmentDealUsecae {
  ShipmentRepository repository;

  CancelShipmentDealUsecae(this.repository);

  Future<CancelDealResponseDto> invoke(
      {required String token, required int dealId}) {
    return repository.cancelDeal(token: token, dealId: dealId);
  }
}
